---
layout: default
title: Wordcut Game - Privacy Policy
lang: en
---

[Français](/wordcut/fr/) | **English**
...
- __Account__ means a unique account created for You to access our Service or parts of our Service. You may create an Account by signing in with a third-party authentication provider such as Apple or Google.
- __Affiliate__ means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.

- __Application__ refers to Wordcut, the software program provided by the Company.

- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Wordcut.
...
- __Firebase__ refers to Google's Firebase platform, which is used by the Company to store Your data, including Your Account information and game progress.

- __Service Provider__ means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used. This includes Google Firebase, which is used as Our data storage and authentication provider.
...
When You sign in using a third-party provider (such as Apple or Google), We may receive Your name and email address from that provider. We do not receive or store Your third-party account password.
...
All Personal Data and Usage Data collected through the Service is stored on Google Firebase. Firebase provides the authentication and database infrastructure for the Service. For more information about Firebase's privacy practices, please visit Google's Privacy Policy.

### Purpose Limitation

Your Personal Data is collected and used __solely for the purpose of saving Your game progress__ and providing the Service. We do __not__ sell, rent, trade, or otherwise share Your Personal Data with third parties for marketing, advertising, or any other commercial purpose. Your data is never used for anything other than enabling and improving Your experience with the Service.

### In-App Purchases

The Service does __not__ offer any in-app purchases. The Application is entirely free to use with no paid features, subscriptions, or microtransactions.
...
## Children's Privacy and Age Policy

The Service has __no age restrictions__ and is intended to be accessible to users of all ages. We do not knowingly collect more Personal Data from children than is necessary to provide the Service.

If You are a parent or guardian and You believe that Your child has provided Us with Personal Data beyond what is needed for the Service, please contact Us. If We become aware that We have collected unnecessary Personal Data from a child without verification of parental consent, We take steps to remove that information from Our servers.

If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.

## Third-Party Authentication Providers

The Service allows You to sign in using third-party authentication providers, including:

- __Apple Sign-In:__ When You choose to sign in with Apple, We receive Your name and email address (or a private relay email address if You choose to hide Your email). Apple's privacy policy governs how Apple handles Your data during the authentication process.
- __Google Sign-In:__ When You choose to sign in with Google, We receive Your name, email address, and profile picture. Google's privacy policy governs how Google handles Your data during the authentication process.

We only use the information received from these providers to create and manage Your Account and to save Your game progress. We do not access any other data from Your Apple or Google accounts.
...
- By email: [adil.hussain.1@ens.etsmtl.ca](mailto:adil.hussain.1@ens.etsmtl.ca)
